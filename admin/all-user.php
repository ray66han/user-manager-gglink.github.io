        ...
        <div class="bodywrapper__inner">
            <div class="row align-items-center mb-30 justify-content-between">
                ...
                <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
                    <form action="https://skillstest.me/admin/users/all/search" method="GET" class="form-inline float-sm-right bg--white">
                            ...
                            <nav aria-label="...">
                                <ul class="pagination justify-content-end mb-0">
                                    <li class="page-item active">
                                        <a class="admin-user-crud.php" href="javascript:void(0)">1</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="admin-user-crud.php" href="https://skillstest.me/admin/users?page=2">2</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="admin-user-crud.php" href="https://skillstest.me/admin/users?page=3">3</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="admin-user-crud.php" href="https://skillstest.me/admin/users?page=4">4</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="admin-user-crud.php" href="https://skillstest.me/admin/users?page=5">5</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="admin-user-crud.php" href="https://skillstest.me/admin/users?page=6">6</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="admin-user-crud.php" href="https://skillstest.me/admin/users?page=7">7</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="admin-user-crud.php" href="https://skillstest.me/admin/users?page=8">8</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="admin-user-crud.php" href="https://skillstest.me/admin/users?page=2">
