    ...
    <div class="row">
        <div class="col-xl-5 col-lg-6 col-md-8 mx-auto">
            <div class="form-wrapper">
                ...
                <form action="https://skillstest.me/admin/password/reset" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group d-flex justify-content-between align-items-center">
                        <a href="https://skillstest.me/admin" class="text-muted text--small">
                            <i class="las la-lock"></i>Login Here </a>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="submit-btn btn-success mt-25 b-radius--capsule">Send Reset Code <i class="las la-sign-in-alt"></i>
                        </button>
                    </div>
                </form>
            </div>
