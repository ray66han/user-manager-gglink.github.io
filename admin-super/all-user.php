                        ...
                        <div class="card-footer py-4">
                            <nav aria-label="...">
                                <ul class="pagination justify-content-end mb-0">
                                    ...
                                    <li class="page-item ">
                                        <a class="page-link" href="https://skillstest.me/admin/users?page=2">2</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="https://skillstest.me/admin/users?page=3">3</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="https://skillstest.me/admin/users?page=4">4</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="https://skillstest.me/admin/users?page=5">5</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="https://skillstest.me/admin/users?page=6">6</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="https://skillstest.me/admin/users?page=7">7</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="https://skillstest.me/admin/users?page=8">8</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="https://skillstest.me/admin/users?page=2">
